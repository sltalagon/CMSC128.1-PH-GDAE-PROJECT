      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-8 flex gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-blue-800 mt-1">
            This tool allows you to explore genes and their disease
            associations. Click on any gene card to view detailed information
            including chromosome location, function, and associated diseases
            with prevalence data for the Philippines.
          </p>
        </div>
      </div>
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm mb-3">
              Encodes the beta chain of hemoglobin, essential for oxygen
