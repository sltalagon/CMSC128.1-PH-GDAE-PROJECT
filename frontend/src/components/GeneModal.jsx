...
import { X, MapPin, FileText, Activity, ExternalLink, Dna } from "lucide-react";
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-blue-600 text-white p-6 relative flex-shrink-0">
          ...
          <div className="flex items-center gap-4">
            {/* The container is now a flexbox to center the icon */}
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 text-slate-600">
              <span className="text-sm font-medium">NCBI Gene ID:</span>
              <a
                href="#"
            ...
            {/* OMIM Section */}
            <div className="flex items-center gap-2 text-slate-600">
              <span className="text-sm font-medium">OMIM ID:</span>
              <a
                href="#"
                className="text-blue-600 hover:underline flex items-center gap-1 text-sm"
              >
                  ...
                  <div className="bg-slate-50 p-4 border-t border-slate-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-slate-400 text-xs">
                        {disease.references.length} reference(s)
                      </span>
                    </div>
                    <div>
