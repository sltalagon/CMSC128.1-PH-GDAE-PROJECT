        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
            {diseaseData.symptoms?.map((symptom, idx) => (
              <div
                key={idx}
                className="bg-slate-50 border border-slate-100 p-3 rounded-lg flex items-center gap-2"
              >
                  ...
                  <div className="bg-white px-4 pb-4">
                    <div className="border-t border-slate-100 pt-4">
                      <p className="text-xs font-semibold text-slate-500 mb-2 uppercase">
                        Supporting References ({gene.references.length}):
                      </p>
                      {gene.references.map((ref, rIdx) => (
                        <div
                          key={rIdx}
                          className="text-sm bg-slate-50 p-3 rounded border border-slate-100"
                        >
